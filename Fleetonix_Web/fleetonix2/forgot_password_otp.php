    ...
    <div class="login-container">
        ...
        <div class="login-card otp-container">
            ...
            <p class="otp-info">
                ...
                <strong><?php echo htmlspecialchars($_SESSION['reset_user_email']); ?></strong>
            </p>
            <p class="otp-info">
                This code will expire in <span class="countdown" id="countdown">5:00</span>
            </p>
            
            <form id="otpForm" method="POST" action="includes/forgot_password_otp_handler.php">
            ...
            <div class="resend-link">
                <p>Didn't receive the code? <a href="includes/resend_reset_otp.php" id="resendLink">Resend OTP</a></p>
            </div>
            
            <div style="text-align: center; margin-top: 20px;">
                <a href="forgot_password.php" style="color: var(--text-secondary); text-decoration: none;">Back</a>
            </div>
        </div>
    </div>
